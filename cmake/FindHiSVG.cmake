...
pkg_check_modules(HISVG hisvg)

set(VERSION_OK TRUE)

if (HISVG_VERSION)
    if (HISVG_FIND_VERSION_EXACT)
        if (NOT("${HISVG_FIND_VERSION}" VERSION_EQUAL "${HISVG_VERSION}"))
            set(VERSION_OK FALSE)
        endif ()
    else ()
        if ("${HISVG_VERSION}" VERSION_LESS "${HISVG_FIND_VERSION}")
            set(VERSION_OK FALSE)
        endif ()
    endif ()
endif ()

if (NOT HISVG_INCLUDE_DIRS)
    set(HISVG_INCLUDE_DIRS ${HISVG_INCLUDEDIR})
endif ()

include(FindPackageHandleStandardArgs)
FIND_PACKAGE_HANDLE_STANDARD_ARGS(HISVG DEFAULT_MSG HISVG_INCLUDE_DIRS HISVG_LIBRARIES VERSION_OK)
